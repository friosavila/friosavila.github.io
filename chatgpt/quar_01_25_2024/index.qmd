...
Ahh! seems this is not working as HTML! The reason is that Latex tables do not render in html. However if you look into the [pdf version](reg1.pdf), you will see that the table is there, and it is correctly named!
