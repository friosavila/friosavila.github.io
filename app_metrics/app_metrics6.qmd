...
The excercise presented here was produce using `Stata`. The modeling was done using the official commands `intreg`. The imputed values were generated out command `intreg_mi`, available upon reqeust. The analysis of the data was performed using `mi`. 
