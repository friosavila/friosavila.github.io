...
This article is a simple example of how to use `Quarto` to create dynamic documents
using `Stata`. Which is possible using the Stata kernel `nbstata' thanks to [Tim Huegerich](https://github.com/hugetim), 
who put this incredible tool together.
...
You can, of course, add other formats. Once this is done, you can see the rest of the code [here](https://github.com/friosavila/friosavila.github.io/blob/main/stata_do/stata_do1.qmd)
